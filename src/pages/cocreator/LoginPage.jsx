...
const LoginPage = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      else if (role === "cochecker") navigate("/cochecker");
      else if (role === "rm") navigate("/rm");
      else if (role === "cocreator") navigate("/cocreator");
      else navigate("/register");

    } catch (err) {
      alert(err?.data?.message || "Incorrect email or password");
    }
  };
